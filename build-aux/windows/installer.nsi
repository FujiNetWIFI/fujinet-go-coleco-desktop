...
; own installer.nsi, renamed for ColecoVision.
;
...
!endif
!ifndef SRCDIR
  !define SRCDIR "dist\FujiNet-Go-ColecoVision"
!endif
!ifndef OUTFILE
  !define OUTFILE "FujiNet-Go-ColecoVision-Setup.exe"
!endif
...
!define APPNAME    "FujiNet Go ColecoVision"
!define PUBLISHER  "Thomas Cherryhomes"
!define EXENAME    "fujinet-go-coleco-windows.exe"
!define HOMEPAGE   "https://fujinet.online/"
!define REGAPP     "Software\FujiNetGoColecoVision"
!define REGUNINST  "Software\Microsoft\Windows\CurrentVersion\Uninstall\FujiNetGoColecoVision"
...
Section "Uninstall"
  ...
  ; fujinet-go-coleco and %LOCALAPPDATA%\fujinet-go-coleco and are
  ; deliberately left behind: an uninstall should not throw away someone's
  ; configuration (including an imported OS7 BIOS, which this project does
  ; not redistribute and the user had to supply), and a reinstall picks it
  ; straight back up.
SectionEnd
