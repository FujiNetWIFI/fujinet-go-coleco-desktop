/*
 * Z80 disassembler for the colecodebug engine. Written fresh from the Zilog
...
static void dasm_main(dctx *d, int ix)
{
    ...
    if (x == 0) {
        ...
        case 0:
            ...
            case 2: {
                ...
                o->flags |= COLECODASM_JUMP | COLECODASM_RELATIVE | COLECODASM_COND;
            ...
            case 3: {
                int8_t e = (int8_t)fetch(d);
                o->target = (uint16_t)(d->addr + 2 + e);
                o->flags |= COLECODASM_JUMP | COLECODASM_RELATIVE;
    ...
    switch (z) {
    case 0:
        o->flags |= COLECODASM_RET | COLECODASM_COND;
    ...
    case 2: {
        uint16_t nn = fetch16(d);
        o->target = nn;
        o->flags |= COLECODASM_JUMP | COLECODASM_COND;
    ...
    case 4: {
        uint16_t nn = fetch16(d);
        o->target = nn;
        o->flags |= COLECODASM_CALL | COLECODASM_COND;
